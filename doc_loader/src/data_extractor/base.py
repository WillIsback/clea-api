...
class ExtractedDocument(BaseModel):
    ...
    :type title: str
    :param content: Contenu brut extrait
    :type content: str
    :param theme: Thème du document
    :type theme: str
    :param document_type: Type (PDF, DOCX, etc.)
    :type document_type: str
    :param publish_date: Date de publication
    :type publish_date: date
    :param embedding: Représentation vectorielle (optionnelle), defaults to None
    :type embedding: Optional[str], optional
    """
...
def stream_split_to_disk(
    ...
    :param meta: Métadonnées du document
    :type meta: Dict
    :param source: Flux de texte à diviser
    :type source: Iterator[str]
    :param max_length: Longueur maximale de chaque chunk
    :type max_length: int
    :return: Un itérateur d'objets ExtractedDocument
